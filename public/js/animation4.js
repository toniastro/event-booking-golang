...
window.onload = function() {
    ...
    var pathOptions = [{color: '#151515',opacity: 1,angle: -50, position: 'TL',x: -400,y: -600,scale: 1},
                   {color: '#585858',opacity: 0.47,angle: 0, position: 'BR',x: 400,y: 280,scale: 1.3},
                   {color: '#3E3E3E',opacity: 0.50,angle: 0, position: 'BR',x: 100,y: 270,scale: 1.3},
                   {color: '#2E2E2E',opacity: 0.61,angle: 180, position: 'TR',x: 300,y: -55,scale: 1}];
