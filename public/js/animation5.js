...
window.onload = function() {
    ...
    var pathOptions = [{color: '#AD6B1D',opacity: 0.33,angle: -50, position: 'TL',x: -400,y: -600,scale: 1},
                   {color: '#6E4514',opacity: 0.22,angle: 0, position: 'BR',x: 400,y: 280,scale: 1.3},
                   {color: '#5C3A13',opacity: 0.5,angle: 0, position: 'BR',x: 100,y: 270,scale: 1.3},
                   {color: '#5C3A13',opacity: 0.61,angle: 180, position: 'TR',x: 300,y: -55,scale: 1}];
